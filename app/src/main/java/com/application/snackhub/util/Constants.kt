package com.application.snackhub.util
...
class Constants {
    ...
    companion object {
        ...
        const val BURGER_CATEGORY = "Burger"
        const val TEA_CATEGORY = "Tea"
        const val SANDWICHS_CATEGORY = "Sandwich"
        const val PIZZA_CATEGORY = "Pizza"
        const val SNACK_CATEGORY = "Snack"
