package com.application.snackhub.firebaseDatabase

import android.util.Log
import com.application.snackhub.model.*
import com.application.snackhub.util.Constants.Companion.ADDRESS_COLLECTION
import com.application.snackhub.util.Constants.Companion.BEST_DEALS
import com.application.snackhub.util.Constants.Companion.CART_COLLECTION
import com.application.snackhub.util.Constants.Companion.CATEGORIES_COLLECTION
import com.application.snackhub.util.Constants.Companion.CATEGORY
import com.application.snackhub.util.Constants.Companion.BURGER_CATEGORY
import com.application.snackhub.util.Constants.Companion.CLOTHES
import com.application.snackhub.util.Constants.Companion.COLOR
import com.application.snackhub.util.Constants.Companion.TEA_CATEGORY
import com.application.snackhub.util.Constants.Companion.ID
import com.application.snackhub.util.Constants.Companion.ORDERS
import com.application.snackhub.util.Constants.Companion.ORDER_CONFIRM_STATE
import com.application.snackhub.util.Constants.Companion.ORDER_PLACED_STATE
import com.application.snackhub.util.Constants.Companion.PRICE
import com.application.snackhub.util.Constants.Companion.PRODUCTS_COLLECTION
import com.application.snackhub.util.Constants.Companion.QUANTITY
import com.application.snackhub.util.Constants.Companion.SIZE
import com.application.snackhub.util.Constants.Companion.STORES_COLLECTION
import com.application.snackhub.util.Constants.Companion.TITLE
import com.application.snackhub.util.Constants.Companion.USERS_COLLECTION
...
class FirebaseDb {
    ...
    fun getBreadVNs(pagingPage: Long) =
        productsCollection.limit(pagingPage).get()

    //add order by orders
    fun getMostOrderedTea(pagingPage: Long) =
        productsCollection.whereEqualTo(CATEGORY, TEA_CATEGORY).limit(pagingPage)
            .orderBy(ORDERS, Query.Direction.DESCENDING).limit(pagingPage).get()

    fun getTeas(pagingPage: Long) =
        productsCollection.whereEqualTo(CATEGORY, TEA_CATEGORY).limit(pagingPage)
