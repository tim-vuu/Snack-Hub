package com.application.snackhub.viewmodel.shopping.cart
...
class CartViewModel(
    ...
    val cartProducts = MusandwichLiveData<Resource<List<CartProduct>>>()
    val cartItemsCount = MusandwichLiveData<Resource<Int>>()
    val plus = MusandwichLiveData<Resource<Int>>()
    val minus = MusandwichLiveData<Resource<Int>>()
    val deleteProduct = MusandwichLiveData<Resource<Boolean>>()
    val product = MusandwichLiveData<Resource<Product>>()
