...
import com.application.snackhub.databinding.BurgerExtraAdsItemBinding
...
class AdsRecyclerAdapter : RecyclerView.Adapter<AdsRecyclerAdapter.AdsViewHolder>() {
    ...
    inner class AdsViewHolder(val binding: BurgerExtraAdsItemBinding) :
    ...
    override fun onCreateViewHolder(
        ...
        return AdsViewHolder(
            BurgerExtraAdsItemBinding.inflate(
